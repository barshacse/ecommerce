...
<!-- Mirrored from html.codedthemes.com/datta-able/bootstrap/tab/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Dec 2019 19:29:52 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}/admin/assets/plugins/notification/css/notification.min.css">
                        ...
                        <div class="sidelink navigation active">
                            <ul class="nav pcoded-inner-navbar">
                                ...
                                <li data-username="Vertical Horizontal Box Layout RTL fixed static Collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=""><a href="{{ route('add-category') }}" class="">Add Categories</a></li>
                                        <li class=""><a href="{{ route('manage-category') }}" class="">Manage Categories</a></li>
                                    </ul>
                                </li>
                                ...
                                <li data-username="Vertical Horizontal Box Layout RTL fixed static Collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=""><a href="{{ route('add-brand') }}" class="">Add Brands</a></li>
                                        <li class=""><a href="{{ route('manage-brand') }}" class="">Manage Brands</a></li>
                                    </ul>
                                </li>
                                ...
                                <li data-username="Vertical Horizontal Box Layout RTL fixed static Collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=""><a href="{{ route('add-product') }}" class="">Add Product</a></li>
                                        <li class=""><a href="{{ route('manage-product') }}" class="">Manage Product</a></li>
                                    </ul>
                                </li>
                                ...
                                {{-- slider --}}
                                <li data-username="Vertical Horizontal Box Layout RTL fixed static Collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                                    <a href="#" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Slider</span></a>
                                    <ul class="pcoded-submenu">
                                        <li class=""><a href="{{ route('add-slider') }}" class="">Add Slider</a></li>
                                        <li class=""><a href="{{ route('manage-slider') }}" class="">Manage Slider</a></li>
                                    </ul>
                                </li>
                                ...
                                {{-- Order --}}
                                <li>
                                    <a href="{{ route('manage-order') }}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Manage Order</span></a>
                                </li>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('/')}}/admin/assets/images/user/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dud-logout" title="Logout">Logout
            ...
            <div class="main-friend-cont scroll-div">
                <div class="main-friend-list">
                    <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe">
                        <a class="media-left" href="#!"><img class="media-object img-radius" src="{{asset('/')}}/admin/assets/images/user/avatar-1.jpg" alt="Generic placeholder image ">
                    ...
                    <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe">
                        <a class="media-left" href="#!"><img class="media-object img-radius" src="{{asset('/')}}/admin/assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
                    ...
                    <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice">
                        <a class="media-left" href="#!"><img class="media-object img-radius" src="{{asset('/')}}/admin/assets/images/user/avatar-3.jpg" alt="Generic placeholder image"></a>
                        <div class="media-body">
                    ...
                    <div class="media userlist-box" data-id="5" data-status="offline" data-username="Suzen">
                        <a class="media-left" href="#!"><img class="media-object img-radius" src="{{asset('/')}}/admin/assets/images/user/avatar-4.jpg" alt="Generic placeholder image"></a>
                        <div class="media-body">
            ...
            <div class="main-chat-cont scroll-div">
                <div class="main-friend-chat">
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="{{asset('/')}}/admin/assets/images/user/avatar-2.jpg" alt="Generic placeholder image"></a>
...
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/amcharts.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/gauge.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/serial.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/light.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/pie.min.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/ammap.min.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/usaLow.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/radar.js"></script>
<script src="{{asset('/')}}/admin/assets/plugins/amchart/js/worldLow.js"></script>

<script src="{{asset('/')}}/admin/assets/plugins/notification/js/bootstrap-growl.min.js"></script>

<script src="{{asset('/')}}/admin/assets/js/pages/dashboard-custom.js"></script>
</body>

<!-- Mirrored from html.codedthemes.com/datta-able/bootstrap/tab/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Dec 2019 19:30:47 GMT -->
</html>

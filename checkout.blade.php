                        ...
                        <div id="checkout-login" class="coupon-content">
                            <div class="login-form mt-0">
                                ...
                                <form action="{{ route('customer-login') }}" method="POST">
                                    @csrf
                                    <p>If you have shopped with us before, please enter your details in the boxes below. If you are a new customer, please proceed to the registration section.</p>
                                    <div class="form-fild">
                            ...
                            <form action="{{ route('new-customer') }}" method="POST">
                                ...
                                <div class="billing-fields">
                                    ...
                                    <div class="form-fild">
                                        ...
                                        <input type="email" placeholder="" name="email" value="" onblur="ajaxEmailCheck(this.value);">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address"  placeholder="" rows="2" cols="5"></textarea>
                                        <span class="text-danger">{{ $errors->has('address')?$errors->first('address'):'' }}</span>
                                    </div>

                                    <div class="form-group">
                                        <p><label></label></p>
                                        <input type="submit" name="btn" value="Registration" id="regbtn" class="btn btn-success"/>
                                    </div>

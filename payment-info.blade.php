                    ...
                    <div class="checkout-form-area">
                        ...
                        <div class="ceckout-form">
                            ...
                            <div class="checkout-title">
                                <h3>Payment Info</h3>
                                <form class="text-center" action="{{ route('new-order') }}" method="POST">
                                    @csrf

                                    <div class="form-group">
                                        <label class="col-md-3">Cash On Delivery</label>
                                        <input type="radio" class="btn btn-xs col-md-2"  value="Cash On Delivery" name="payment_type"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3">Paypal</label>
                                        <input type="radio" class="btn btn-xs col-md-2" value="Paypal" name="payment_type"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3">SSL Commerce</label>
                                        <input type="radio" class="btn btn-xs col-md-2" value="SSL_Commerce" name="payment_type"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3">Bkash</label>
                                        <input type="radio" class="btn btn-xs col-md-2" value="Bkash" name="payment_type"/>
                                    </div>
